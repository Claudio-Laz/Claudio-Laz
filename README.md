...
- Innové el área analítica desarrollando un sistema inteligente de análisis web in house.
...
| **Inteligencia de Negocios** | **Lenguajes** |
|---|---|
...
| **Frameworks Web** | **Bases de Datos** | **Cloud & DevOps** |
|---|---|---|
